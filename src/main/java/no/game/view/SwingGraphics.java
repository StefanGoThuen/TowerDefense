...
// University of Bergen helper methods for graphics with Swing.
...
public class SwingGraphics {
	...
	public static void drawCenteredString(Graphics g, String s, Point2D p) {
		SwingGraphics.drawCenteredString(g, s, p.getX(), p.getY());
	}
	...
	public static void drawCenteredString(Graphics g, String s, Shape shape) {
		SwingGraphics.drawCenteredString(g, s, shape.getBounds2D().getCenterX(),
	...
	public static void drawImage(Graphics g, Image image, double x, double y,
			double scale) {
		SwingGraphics.drawImage(g, image, x, y, scale, 0);
	}
	...
	public static void drawCenteredImage(Graphics g, Image image, double cx, double cy,
			double scale) {
		SwingGraphics.drawCenteredImage(g, image, cx, cy, scale, 0);
	}
	...
	public static BufferedImage loadImageFromResources(String filename) {
		...
		InputStream is = SwingGraphics.class.getResourceAsStream(filename);
		if (is == null) {
